...
const IconStandardEmail = ({color = createColor('misc', 'white')}) => {

  return (
    <svg viewBox="0 0 26 26">

      <path fill={color} d="M24.6,5.2c-0.1-0.5-0.5-0.9-1-0.9H2.4c-0.5,0-1,0.5-1,1v15.3c0,0.6,0.4,1,1,1h21.3c0.6,0,1-0.4,1-1V5.4C24.6,5.3,24.6,5.3,24.6,5.2C24.6,5.2,24.6,5.3,24.6,5.2z M20.8,6.4L13,12.5L5.2,6.4H20.8z M3.4,19.6V7.4l9,7.1c0.4,0.3,0.9,0.3,1.2,0l9-7.1v12.2H3.4z"/>
...
const IconStandardPhone = ({color = createColor('misc', 'white')}) => {
