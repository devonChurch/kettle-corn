...
const IconStandardEmail = ({color = createColor('misc', 'white'), isInline = false}) => {
...
const IconStandardTwitter = ({color = createColor('misc', 'white'), isInline = false}) => {
...
const IconStandardFacebook = ({color = createColor('misc', 'white'), isInline = false}) => {
...
const IconStandardPhone = ({color = createColor('misc', 'white'), isInline = false}) => {
